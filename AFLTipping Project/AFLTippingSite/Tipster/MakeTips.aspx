...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:MultiView ID="mtvMakeTips" ActiveViewIndex="0" runat="server">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2 text-md-center">
                        <asp:DropDownList ID="ddlTippingRounds" runat="server" DataSourceID="RoundDataSource" DataTextField="roundID" DataValueField="roundID" CssClass="form-control "></asp:DropDownList>
                    </div>
                </div>
                <br />
        ...
        <asp:View runat="server" ID="displayRound">
            ...
            <br />
            <div class="row">
                <asp:Button ID="btnSubmitTips" Text="Submit" CssClass="btn btn-primary col-md-2 col-md-offset-" runat="server" OnClick="btnSubmitTips_Click" />
